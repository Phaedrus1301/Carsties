    ...
    return (
        <form className='flex flex-col mt-3' onSubmit={handleSubmit(onSubmit)}>
            ...
            <>
                ...
                <div className='grid grid-cols-2 gap-3'>
                    <Input name='reservePrice' label='Reserve Price(0 if no reserve)' 
                        control={control} type='number' 
                        rules={{required: 'Reserve price is required'}}/>
                    <DateInput name='auctionEnd' label='Auction End date/time' 
                        control={control} rules={{required: 'Auction end date is required'}}
                        showTimeSelect dateFormat='dd MM yyyy h:mm a'/>
                </div>
            </>
            }
